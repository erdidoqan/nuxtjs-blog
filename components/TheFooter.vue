        ...
        <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
              <li class="mb-4">
                <NuxtLink to="/about-us/" class="inline-flex items-center font-medium text-green-600 hover:underline">
                  About Us
                </NuxtLink>
              </li>
              <li class="mb-4">
                <NuxtLink to="/author/" class="inline-flex items-center font-medium text-green-600 hover:underline">
                  Authors
                </NuxtLink>
              </li>

              <li class="mb-4">
                <NuxtLink to="/category/" class="inline-flex items-center font-medium text-green-600 hover:underline">
                  All Categories
                </NuxtLink>
              </li>
              <li class="mb-4">
                <NuxtLink to="/terms-and-conditions/" class="inline-flex items-center font-medium text-green-600 hover:underline">
                  Terms and Conditions
                </NuxtLink>
              </li>
              <li class="mb-4">
                <NuxtLink to="/privacy-policy/" class="inline-flex items-center font-medium text-green-600 hover:underline">
                  Privacy Policy
                </NuxtLink>
              </li>
              <li class="mb-4">
                <NuxtLink to="/contact-us/" class="inline-flex items-center font-medium text-green-600 hover:underline">
                  Contact Us
                </NuxtLink>
              </li>
            </ul>
      ...
      <nav class="flex flex-wrap justify-center -mx-5 -my-2" aria-label="Footer">
        ...
        <NuxtLink to="/" class="flex items-center mb-2 font-medium text-gray-900 title-font md:mb-0">
          <nuxt-img
            ...
            quality="100"
          />
          <span class="h-8 text-green-700 pl-2 text-2xl">{{ siteTitle }}</span>
        </NuxtLink>
      </nav>
