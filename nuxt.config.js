...
https.get((process.env.MAIN_URL || 'https://icerikplanla.com')+'/atom/'+process.env.PUBLISH_URL, resp => resp.pipe(fs.createWriteStream('static/feed.xml')));
https.get((process.env.MAIN_URL || 'https://icerikplanla.com')+'/feed/'+process.env.PUBLISH_URL, resp => resp.pipe(fs.createWriteStream('static/rss.xml')));
https.get((process.env.MAIN_URL || 'https://icerikplanla.com')+'/sitemaps/image/'+process.env.PUBLISH_URL, resp => resp.pipe(fs.createWriteStream('static/sitemap-image.xml')));
https.get((process.env.MAIN_URL || 'https://icerikplanla.com')+'/sitemaps/news/'+process.env.PUBLISH_URL, resp => resp.pipe(fs.createWriteStream('static/news_sitemap.xml')));
