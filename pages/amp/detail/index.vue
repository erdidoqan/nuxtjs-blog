  ...
  <div>
    ...
    <header class="pt-10 pb-5 sm:pb-16 sm:text-center">
      ...
      <p class="max-w-3xl mx-auto text-lg text-slate-700 dark:text-slate-400 p-5">
        Welcome to our exceptional world of captivating detail, carefully curated just for you! We take immense
              ...
              <div>
                <div class="ltablet:grid-cols-6 grid w-full gap-6 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4">
                  ...
                  >
                    ...
                    <div class="relative">
                      <NuxtLink :to="`/amp/detail/${article.slug}/?utm_source=amp`">
...
export default {
  async asyncData({ $content, params, $axios }) {
    try {
      const articles = await $axios.$get(process.env.API_URL + '/category/detail')
    ...
    breadcrumbs() {
      return {
        lists: [
          ...
          { name: "Detail", url: "/detail", ok: false }
        ],
      }
    }
  },
    ...
    jsonld() {
      return {
        ...
        "itemListElement": [
          this.articles.map((article, index) => {
            return {
              "@type": "ListItem",
              "position": index + 1,
              "url": 'https://' + process.env.PUBLISH_URL + '/detail/' + article.slug,
              "name": article.title
            }
          })
        ],
        ...
        "mainEntityOfPage": {
          ...
          "@id": 'https://' + process.env.PUBLISH_URL + '/detail/',
          "name": "Details & Ratings From the " + process.env.SITE_TITLE,
          "headline": "Details",
        ...
        "url": 'https://' + process.env.PUBLISH_URL + '/detail/'
      }
    },
  },
  head() {
    return {
      ...
      link: [
        ...
        { rel: 'canonical', href: 'https://' + process.env.PUBLISH_URL + '/detail/' }
      ],
      script: [{
