...
export default {
  ...
  head() {
    return {
      ...
      meta: [
        { hid: "description", name: "description", content: 'Discover the perfect  quotes, heartfelt wishes, and charming captions to make your loved ones special day even more memorable'},
