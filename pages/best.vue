      ...
      <div class="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
        <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div class="sm:max-w-lg">
            <h1 class="text-4xl text-white font-bold tracking-tight text-gray-900 sm:text-6xl"> Find the Best Vehicle, Cars and Electric Cars </h1>
            ...
            <ul class="max-w-md space-y-1 mt-5 text-white list-inside text-xl">
              ...
              <li class="flex items-center">
                ...
                Helping you find Vehicle, Cars and Electric Cars
              </li>
              <li class="flex items-center">
                <svg class="w-3.5 h-3.5 me-2 text-green-500 dark:text-green-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
...
export default {
  ...
  head() {
    return {
      title: 'Find the Best Vehicle, Cars and Electric Cars - '+process.env.SITE_TITLE,
      meta: [
        { hid: "description", name: "description", content: 'Discover the perfect  Vehicle, Cars and Electric Cars to make your loved ones special day even more memorable'},
